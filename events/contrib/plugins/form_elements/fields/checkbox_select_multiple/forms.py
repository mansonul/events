...
from events.base import BaseFormFieldPluginForm, get_theme
from events.helpers import validate_initial_for_multiple_choices
...
class CheckboxSelectMultipleInputForm(forms.Form, BaseFormFieldPluginForm):
    ...
    choices = forms.CharField(
        ...
        widget=forms.widgets.Textarea(
            attrs={'class': theme.form_element_html_class,
                   'placeholder': 'Add list items one under the other in the order you want the invitees to see them on your event page as shown below:\nSalt\nPepper\nOil'}
        )
    )
